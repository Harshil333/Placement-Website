...
<div class="container">
    ...
    <form action="{{url('/employers/'.$user_id)}}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="file" id="img" name="company_image" accept="image/*">
        </div>
        <div class="form-group">
            <label for="contact_desk">Contact Desk:</label>
            <input type="text" class="form-control" id="contact_desk" placeholder="Enter a helpline number" name="contact_desk">
        </div>
        <div class="form-group">
            <label for="bio">Description:</label>
            <textarea class="form-control" id="bio" placeholder="Enter a short and sweet description of your company" name="description"></textarea>
        </div>
