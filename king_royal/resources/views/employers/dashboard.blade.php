      ...
      <div class="col-md-4">
        <ul class="list-group" style="width:fit-content; margin-top: auto;">
          <li class="list-group-item d-flex justify-content-between align-items-center">
            <a class="dropdown-item" href="{{url('/employers/'.Auth::user()->id.'/dashboard')}}">Dashboard</a>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center">
            <a class="dropdown-item" href="{{url('/jobs/new')}}">Post a new Job</a>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center">
            <a class="dropdown-item" href="{{url('/manage_jobs')}}">Manage Jobs</a>
            <span class="badge badge-primary badge-pill" style="margin-left: 5px;">1</span>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center">
            <a class="dropdown-item" href="{{url('/manage_candidates')}}">Manage Candidates</a>
            <span class="badge badge-primary badge-pill" style="margin-left: 5px;">1</span>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center">
      ...
      <div class="col-md-8" style="margin-top: 70px;">
        <div class="card-columns">
          ...
          <div class="card-body text-center">
            <p class="card-text">{{$posted_jobs}} Active job listings</p>
          </div>
        </div>
        <div class="card bg-warning" style="margin-left: 50px;">
          <div class="card-body text-center">
            <p class="card-text">{{$applied_jobs}} Job applications</p>
          </div>
        </div>
      </div>
    <!-- </div> -->
