...
@section('content')
<div class="container">
    <h2 class="text-center">New Employer</h2>
    <form action="{{url('/employers')}}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mb-2 mr-sm-2" id="company_name" placeholder="Enter your company name" name="company_name">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="url" class="form-control" id="facebook" placeholder="Enter your Facebook Profile url" name="facebook">
        </div>
        <div class="form-group">
