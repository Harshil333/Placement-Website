    ...
    <div class="row">
      <div class="col-md-4">
        <ul class="list-group" style="width:fit-content; margin-top: auto;">
          <li class="list-group-item d-flex justify-content-between align-items-center">
            <a class="dropdown-item" href="{{url('/candidates/'.Auth::user()->id.'/dashboard')}}">Dashboard</a>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center">
            <a class="dropdown-item" href="{{url('/jobs/applied')}}">Applied Jobs</a>
            <span class="badge badge-primary badge-pill" style="margin-left: 5px;">1</span>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center">
            <a class="dropdown-item" href="{{url('/jobs/matched')}}">Matched Jobs</a>
            <span class="badge badge-primary badge-pill" style="margin-left: 5px;">1</span>
          </li>
          <li class="list-group-item d-flex justify-content-between align-items-center">
      ...
      <div class="col-md-8" style="margin-top: 70px;">
        ...
        <div class="card bg-warning" style="margin-left: 50px;">
          <div class="card-body text-center">
            <p class="card-text">{{$matched_jobs}} Job matches</p>
          </div>
        </div>
      </div>
    <!-- </div> -->
