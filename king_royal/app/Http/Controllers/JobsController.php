...
class JobsController extends Controller
{
    ...
    public function manage_jobs(){
        $jobs = Job::where('employer_name',auth()->user()->first_name.' '.auth()->user()->last_name)->get();
    ...
    public function create(Request $request){
        ...
        $job->employer_name = auth()->user()->first_name.' '.auth()->user()->last_name;
        $job->company_name = $request->input('company_name');
        $job->category_name = $request->input('category_name');
        $job->save();

        return redirect()->back()->with('success','A new Job has been created!');
    }
    ...
    public function update(Request $request,$id){
        ...
        return redirect()->back()->with('success','The job has been updated!');
    }
